...
public class Controller_RegistrazioneAdmin 
{
	...
	public void Registrati() throws CloneNotSupportedException 
	{
		...
		String text=("Username: "+ListaDatiAccesso.ricerca(code).getUsernameAdmin()+"  Password: "+ListaDatiAccesso.ricerca(code).getPassword()+"     premi annulla per tornare al Login");
